...
// Given JSON Data about Companies
Data= [
    {
    ...
    let tablebody = document.getElementById("tableBody"); // get body of table and store in tablebody

    // iterate over the JSON Data, which is a list of objects
    // element here is the json object 
    Data.forEach( element => {

        // HTML Table Row Element
        let row = document.createElement("tr"); // tr is stored in row

        // HTML Table Cell element -- company name
        let companyCell = document.createElement("td"); //td is stored in companyCell
        // change the original data, text here in company cell
        companyCell.textContent = element.company_name; // company name in JSON's data is stored in companyCell
        // append the company name to the row
        row.appendChild(companyCell);

        // HTML Table Cell element -- logo
        let logoCell = document.createElement("td"); // table data stored in logoCell
        let imgLogo = document.createElement("img"); // imag stored in imgLogo
        imgLogo.src = element.img_src; // imgLogo has URL of img_src
        logoCell.appendChild(imgLogo);
        // append the company logo to the row
        row.appendChild(logoCell);

        // HTML Table Cell element -- about
        let aboutCell = document.createElement("td"); 
        aboutCell.textContent = element.about;
